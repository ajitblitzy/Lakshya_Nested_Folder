...
| File                                           | Purpose                                             |
| ---------------------------------------------- | --------------------------------------------------- |
| `lib/internal/webstreams/adapters.js`          | Bridges between Node.js-style and Web-style streams |
...
| --------------------------------------------------------------- | --------------------------- | -------------------------------------------- |
| `node:fs` create-read/write stream                              | Node.js Readable / Writable | [`../api/fs.md`](../api/fs.md)               |
| `process.stdin`, `stdout`, `stderr`                             | Node.js Readable / Writable | [`../api/process.md`](../api/process.md)     |
| `node:http` `IncomingMessage`, `ServerResponse`                 | Node.js Readable / Writable | [`../api/http.md`](../api/http.md)           |
| `node:zlib` `Gzip`, `Deflate`, `BrotliCompress`, `ZstdCompress` | Transform                   | [`../api/zlib.md`](../api/zlib.md)           |
| `node:net` `Socket`                                             | Node.js Duplex              | [`../api/net.md`](../api/net.md)             |
| `node:tls` `TLSSocket`                                          | Node.js Duplex              | [`../api/tls.md`](../api/tls.md)             |
| `fetch()` `Response.body`                                       | Web `ReadableStream`        | [`../api/globals.md`](../api/globals.md)     |
| `node:zlib` iterable compression API                            | Node.js Readable            | [`../api/zlib_iter.md`](../api/zlib_iter.md) |
