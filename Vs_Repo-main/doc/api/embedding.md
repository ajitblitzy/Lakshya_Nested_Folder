...
> See also: For layered-architecture context and the runtime's V8/event-loop integration model, refer to
> [Architecture: integration](../architecture/integration.md) and
